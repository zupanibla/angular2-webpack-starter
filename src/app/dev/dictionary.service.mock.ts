...
export class MockDictionaryService extends DictionaryService {
	private _words = new BehaviorSubject<Array<WordData>>([{"text":"drug","pronounciation":"druhg","definitions":["a habit-forming medicinal or illicit substance, especially a narcotic."]},{"text":"drug","pronounciation":"druhg","definitions":["a simple past tense and past participle of"]},{"text":"Drug","pronounciation":"droo g","definitions":["the cosmic principle of disorder and falsehood."]}]);
